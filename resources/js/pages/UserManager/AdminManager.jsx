...
export default function AdminManagement({ users, roles }) {
    const { abilities, checkAbility } = useAbilities('Admin Manager');
    ...
    const handleAssignRole = (e) => {
        e.preventDefault()
        post(route('admins.assignRole', data.id), {
            onSuccess: () => {
    ...
    const handleSuspendToggle = () => {
        const routeName = data.actionType === "suspend" ? "admins.suspend" : "admins.unsuspend";
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6 space-y-6">
              { abilities?.can_create && <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-semibold text-slate-800 dark:text-white">Admin Users</h1>
                ...
                {data.showDeleteConfirm && (
                    <SweetAlert
                        ...
                        action={() => destroy(route("admins.destroy", data.id), {
                ...
                {data.showSuspendConfirm && (
                    <SweetAlert
                        ...
                        confirm={true}
                        message={`Are you sure you want to ${data.actionType} this admin account?`}
