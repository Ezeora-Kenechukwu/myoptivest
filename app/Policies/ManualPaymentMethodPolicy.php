...
class ManualPaymentMethodPolicy
{
     ...
     */
    public function restore(User $user, ManualPaymentMethod $manualPaymentMethod): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, ManualPaymentMethod $manualPaymentMethod): bool
    {
        return false;
    }
}
