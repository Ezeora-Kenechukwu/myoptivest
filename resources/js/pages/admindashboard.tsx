...
import AdminSavingsStatusChart from './Dashboard/AdminSavingsStatusChart';
...
const transactionColumns = [
  ...
  { name: "Payment Method", selector: "method", sortable: true },
  {
    name: "Action",
    selector: "action",
    sortable: false,
...
export default function Admindashboard({ auth: user,transactions, main_balance  }) {
